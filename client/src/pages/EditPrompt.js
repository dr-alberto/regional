...
import { Dialog, Transition, RadioGroup, Listbox, Switch } from '@headlessui/react'
                            ...
                            <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl">
                                ...
                                <div className='px-4 pb-4 pt-5 sm:p-6 sm:pb-4'>
                                    <div className="mt-3 text-center sm:mt-0 sm:text-left">
                                        <Dialog.Title as="h3" className="text-base font-semibold leading-6 text-gray-900">Add this prompt to your website</Dialog.Title>
                                    </div>
                                    <div className="mt-5">
                                            ...
                                            <RadioGroup.Option value="manual">
                                                {({ checked }) => (
                                                    <div className={
                                                        ...
                                                        <div className='block text-sm leading-6 text-gray-700'>Add a script to your html template</div>
                                                    </div>
                                                )}
                                            </RadioGroup.Option>
                                            <RadioGroup.Option value="wordpress">
                                                {({ checked }) => (
                                                    <div className={
                                                        ...
                                                        <div className='block text-sm leading-6 text-gray-700'>Custom Wordpress integration</div>
                                                    </div>
                                                )}
                                            </RadioGroup.Option>
                                        ...
                                        {publish === 'manual' && (
                                            <div className="flex flex-col mt-10">
                                                    <div className="font-semibold leading-6 text-gray-900">Integrate manually</div>
                                                    <div className="text-sm leading-6 text-gray-700">Copy and paste this code at the top of your {'<body>'} tag</div>
                                                ...
                                                <div className="mt-2">
                                                    ...
                                                    >
                                                        {`<script defer src='${ENDPOINT}/widget/widget-bundle.js' data-widget='regionalhq-prompt' id='${id}'></script>\n<div id='widget-root'></div>`}
                                                    </textarea>
                                                </div>
                                            </div>
                                        )}
        ...
        <>
            ...
            <header className="bg-white border-b border-zinc-100">
                <div className="flex justify-between mx-auto max-w-7xl px-4 py-1 sm:px-6 lg:px-8">
                    <div>
                        <h1 className="text-xl font-bold tracking-tight text-gray-900">Edit prompt</h1>
                        <div>
                            <span className='font-semibold'>Prompt: </span>
                            <span>{promptData.name}</span>
                        </div>
                    </div>
                                ...
                                <div>
                                    ...
                                    <div className='mt-5'>
                                        <div className="flex justify-between items-center">
                                            ...
                                            <TextLink text={'Edit portal'} url={`/portals/${portalData.id}`}/>
                                        </div>
                                        <div className="mt-2">
                                            <div
                                                className="ring-1 ring-gray-300 rounded-md relative w-full cursor-default bg-white py-1.5 pl-3 pr-10 text-left text-gray-900 shadow-sm focus:outline-none sm:text-sm sm:leading-6"
                                            >
                                                <span className="flex items-center">
                                                <span className="block truncate">{portalData.name}</span>
                                                </span>
                                    ...
                                    <div className='mt-5'>
                                        ...
                                        <Switch
                                            ...
                                            className={`${
                                                promptData.showOnlyToNonAvailableRegions ? 'bg-teal-600' : 'bg-gray-200'
                                            } relative inline-flex h-6 w-11 items-center rounded-full mt-2`}
                                            >
                                            <span className="sr-only">Enable notifications</span>
                                            <span
                                                className={`${
                                                promptData.showOnlyToNonAvailableRegions ? 'translate-x-6' : 'translate-x-1'
                                    ...
                                    <div className='mt-5'>
                                        ...
                                        <div className="mt-2">
                                            <Select
                                                ...
                                                onChange={(e) => setPromptData(prevData => ({ ...prevData, font: e }))}
                                            ></Select>
                                        </div>
                                    </div>
                                    ...
                                    <div className='mt-5'>
                                        ...
                                        <div className="mt-2">
                                            <Select
                                                ...
                                                onChange={(e) => setPromptData(prevData => ({ ...prevData, style: e }))}
                                            ></Select>
                                        </div>
                                    </div>
                            ...
                            <div className="col-span-8">
                                <div class="flex justify-between mx-4 mt-4">
                                    ...
                                    <div
                                        ...
                                        <div className='px-4 pb-4 pt-5 sm:p-6 sm:pb-4'>
                                            <div className="mt-3 text-center sm:mt-0 sm:text-left">
                                                <div as="h3" className="text-xl font-semibold leading-6 text-gray-900">Check if {portalData.brandName} is available in your region</div>
                                            </div>
                                            <div className="mt-5">
                                                <form id="form-name">
                                                    <div className="flex flex-col">
                                        ...
                                        <div className="bg-white p-4 flex sm:flex-row flex-col justify-between items-center">
                                            <a style={{ fontFamily: 'system-ui, sans-serif' }} className="text-sm flex gap-x-2 items-center mb-4 sm:mb-0 cursor-pointer">
                                                Powered by 
