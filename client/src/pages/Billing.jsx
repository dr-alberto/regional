...
export default function Billing() {
  ...
  const openCheckout = (e, pricesMapping, yearly) => {
    e.preventDefault();

    const priceId = yearly ? pricesMapping.yearly : pricesMapping.monthly;
            ...
            <div className="mx-auto max-w-2xl sm:text-center">
              ...
              <Switch.Group>
                <div className="flex items-center justify-center mt-4 text-sm">
                  <Switch.Label className="mr-4">Monthly</Switch.Label>
                  <Switch
                    checked={yearly}
                    onChange={setYearly}
                    className={`${
                      yearly ? "bg-teal-600" : "bg-gray-200"
                  ...
                  <Switch.Label className="ms-4">
                    Yearly{" "}
                    <span className="font-bold text-teal-600">(save 16%)</span>
                  </Switch.Label>
                </div>
              </Switch.Group>
            </div>
            ...
            <div className="grid grid-cols-3 gap-x-3">
              <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:max-w-none">
                  ...
                  <div className="rounded-2xl bg-gray-50 py-10 h-full text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                    <div className="mx-auto max-w-xs px-8">
                      <p className="mt-6">
                        ...
                        <span className="text-sm font-semibold leading-6 tracking-wide text-gray-600 ms-1">
                          USD
                        </span>
                      </p>
                      <span className="text-sm font-semibold leading-6 tracking-wide text-gray-600">
                        per month {yearly && "billed yearly"}
                      </span>
                      {userPlan === 0 && (
                        <form
                          onSubmit={(e) =>
                            openCheckout(e, plans.startup, yearly)
                          }
                        >
                          <input type="hidden" />
                          <button
                ...
                <div className="p-8 sm:p-10 flex-grow">
                  <div className="flex gap-x-3 items-center">
                    ...
                    {userPlan === 1 && (
                      <>
                        ...
                        <div className="font-semibold leading-6 text-teal-600">
                          Active
                        </div>
                      </>
                    )}
                  ...
                  <p className="mt-6 text-base leading-7 text-gray-600">
                    Ideal for small teams, create one portal with the essential
                    analytics.
                  </p>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-x-4 mt-5">
                      <h4 className="flex-none text-sm font-semibold leading-6 text-zinc-800">
                        Portal
                      </h4>
                    </div>
                    <li className="flex gap-x-3">
              ...
              <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:max-w-none">
                  ...
                  <div className="rounded-2xl bg-gray-50 py-10 h-full text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                    <div className="mx-auto max-w-xs px-8">
                      ...
                      {userPlan === 0 && (
                        <form
                          onSubmit={(e) =>
                            openCheckout(e, plans.expansion, yearly)
                          }
                        >
                          <input type="hidden" />
                          <button
                ...
                <div className="p-8 sm:p-10 flex-grow">
                  ...
                  <p className="mt-6 text-base leading-7 text-gray-600">
                    For growing businesses with multiple products, create up to
                    10 portals and priority customer support.
                  </p>
                  <div className="mt-10 flex items-center gap-x-4">
                    <h4 className="flex-none text-sm font-semibold leading-6 text-teal-600">
                      What's included
              ...
              <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:max-w-none">
                  ...
                  <div className="rounded-2xl bg-gray-50 py-10 text-center h-full ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                    <div className="mx-auto max-w-xs px-8">
                      ...
                      {userPlan === 0 && (
                        <form
                          onSubmit={(e) =>
                            openCheckout(e, plans.growth, yearly)
                          }
                        >
                          <input type="hidden" />
                          <button
                ...
                <div className="p-8 sm:p-10 lg:flex-growth">
                  ...
                  <p className="mt-6 text-base leading-7 text-gray-600">
                    Premium features for large-scale operations, create
                    unlimited portals plus the option to self host your portals
