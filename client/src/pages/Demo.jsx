...
export default function Demo() {
  ...
  useEffect(() => {
    document.title = "Live demo · Regional";
        ...
        >
          <div className="flex lg:flex-1">
            <a href="/" className="-m-1.5 p-1.5">
              ...
              <img className="h-9 w-auto" src="/logo.svg" alt="" />
            </a>
          </div>
            ...
            {({ checked }) => (
              ...
              >
                ...
                <div className="block text-md mt-1 leading-6 text-gray-700">
                  Cultivate a pre-existing audience for launches in new regions.
                </div>
              </div>
            )}
          </RadioGroup.Option>
          ...
          >
            {({ checked }) => (
              ...
              >
                ...
                <div className="block text-md mt-1 leading-6 text-gray-700">
                  The easiest way to add a portal to your website.
                </div>
              </div>
            )}
          </RadioGroup.Option>
      ...
      {demo === "portal" && (
        <>
          <RadioGroup value={portalSample} onChange={setPortalSample}>
            <RadioGroup.Label
              className={
                "block text-sm font-medium leading-6 text-gray-900 mt-4"
              }
            >
              Select an example
            </RadioGroup.Label>
              ...
              >
                {({ checked }) => (
                  ...
                  >
                    ...
                    <div className="block text-md mt-1 leading-6 text-gray-700">
                      Capture interested users from other regions in your
                      register page.
                    </div>
                  </div>
                )}
