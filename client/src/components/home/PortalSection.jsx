      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            ...
            <div className="lg:max-w-lg">
              ...
              <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                <div className="relative pl-9">
                  ...
                  <dd className="inline">
                  Capture users from regions where your products aren't available for later instead of losing them.
                  </dd>
                </div>
                <div className="relative pl-9">
                  <dt className="inline font-semibold text-gray-900">
                  ...
                  <dd className="inline">
                    Launch in new regions easily with a list of leads already created.
                  </dd>
                </div>
              </dl>
          ...
          <img
            ...
            loading="lazy"
            className="w-[58rem] max-w-none rounded-md shadow-md ring-1 ring-teal-600/25 sm:w-[57rem] md:-ml-4 lg:-ml-0"
          />
        </div>
      </div>
    </div>
