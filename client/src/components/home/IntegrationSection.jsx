        ...
        <div className="flex flex-col mt-10 items-center">
          <div className="w-5/12">
            ...
            <input
              ...
              value={DEMO_LINK}
              disabled
              className="w-full mx-auto rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-gray-600 sm:text-sm sm:leading-6"
            />
          </div>
        </div>
