    ...
    <div id="pricing" className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <div className="font-bold mt-3 text-teal-600">
            {t("pricing_helper")}
          </div>
        </div>
