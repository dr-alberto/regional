...
export const UpgradePlanModal = ({ open, setOpen }) => {
                ...
                <div className="px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="mt-10 flex flex-col items-center text-center px-8">
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      fill="currentColor"
                      className="w-24 h-24 fill-teal-600"
                    >
                      <path
                        fillRule="evenodd"
                    ...
                    <p className="text-gray-600 mt-2">
                      Upgrade your plan now to access this feature and many
                      more.
                    </p>
                  </div>
                </div>

                <div className="bg-white mt-8 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  <a
                    href="/billing"
