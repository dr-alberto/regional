...
export default function SetCustomDomain({site, userPlan, startupPriceId, expansionPriceId, growthPriceId}) {
    ...
    return !loading && (
        <form onSubmit={handleCustomDomainSubmit}>
            ...
            <div className="space-y-12">
                ...
                <p className="text-gray-600 text-sm">Display the portals of this site in a custom subdomain.</p>
